...
describe('Context', () => {
    ...
    describe('Api', () => {
        describe('Create', () => {
            it('Creates given context as an execution context', () => {
                Context.create({});
            ...
            it('Returns target', () => {
                ...
                expect(Context.get()).toEqual(target);
            });

            it('Expose execution context data', (done) => {
    ...
    describe('Context Availability', () => {
        ...
        describe('Domains', () => {
            it('Allows to create sub domains under a root context', (done) => {
                ...
                setTimeout(() => {
                    Context.create({ some: 'where', hey: false });
